...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        final String packageName = "com.shop";
        final String projectPath = System.getProperty("user.dir")+"/shop-address";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/"+packageName.replaceAll("\\.","/")+"/" + pc.getModuleName()
